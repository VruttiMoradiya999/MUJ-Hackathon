...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_inventory(self, obj):
        ...
        return {
            ...
            "reorder_level": (
                float(obj.reorder_level)
                if obj.reorder_level is not None
                else None
            ),
        }
    ...
    def get_supplier(self, obj):
        ...
        return {
            ...
            "minimum_order_quantity": (
                float(obj.minimum_order_quantity)
                if obj.minimum_order_quantity is not None
                else None
            ),
...
class SaleItemSerializer(serializers.ModelSerializer):
    """Read-only representation of a sale line item."""
...
class SaleSerializer(serializers.ModelSerializer):
    """Read-only representation returned after a sale."""
...
class SaleItemInputSerializer(serializers.Serializer):
    """One item received by POST /api/sales/."""
